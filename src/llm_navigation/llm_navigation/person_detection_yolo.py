...
class RgbdYoloPerceptionNode(Node):
    ...
    def __init__(self):
        ...
        self.gui_window_name = "RGB-D YOLO Detections"
        if self.show_gui:
    ...
    def sync_callback(self, rgb_msg: Image, depth_msg: Image):
        ...
        if len(results) > 0 and len(results[0].boxes) > 0:
            ...
            # Draw all detections on GUI frame
            annotated_frame = results[0].plot()

            # Use the first detection that matches the exact YAML class list.
            selected_box = None
            ...
            if selected_box is None:
                ...
                # Safe bounds check before depth lookup
